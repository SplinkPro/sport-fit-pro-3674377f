                  ...
                  <div className="flex flex-col items-center gap-3">
                    ...
                    {parseResult && (
                      <div className="flex flex-col items-center gap-2 text-sm">
                        ...
                        {/* Show unrecognized columns as diagnostic */}
                        {parseResult.unmappedColumns && parseResult.unmappedColumns.filter(c => c && !["sl no","slno","#"].includes(c.toLowerCase())).length > 0 && (
                        ...
                        {parseResult.athletes.length === 0 && parseResult.skipped > 0 && (
                          <div className="bg-red-50 border border-red-200 rounded-lg px-3 py-2 text-left max-w-sm">
                            ...
                            <p className="text-xs text-red-600">
                              Column "Athlete Name" (or "Name") was not found. Detected columns: {" "}
                              <span className="font-mono">{parseResult.headerSnapshot?.slice(0, 5).join(", ") ?? "none"}</span>
                            </p>
